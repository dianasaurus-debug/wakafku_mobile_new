...
class _AddReminderPageState extends State<AddReminderPage> with DialogMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: SecondAppBar(appBar: AppBar(), title: 'Tambah Penjadwalan'),
                      ...
                      Row(
                        children: [
                          Container(
                            ...
                            child: Image.network(IMG_PATH+vm.scheduled_program!.cover, fit: BoxFit.cover),
                          ),
                          Expanded(
                            child: Text(vm.scheduled_program!.title, style: CustomFont.blackMedBold),
                          )
                        ],
                      ),
