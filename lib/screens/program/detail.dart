          ...
          child : Column(
            ...
            children : [
              ...
              Padding(
                ...
                child : Text('Program Indonesia Berwakaf', style: CustomFont.blackBigBold,),
              ),
              Padding(
                      ...
                      child : Row(
                        ...
                        children: [
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Terkumpul', style: CustomFont.blackMedLight,),
                              ...
                              Row(
                                children: [
                                  ClipOval(
                                    child: Material(
                                        color: Colors.grey.withOpacity(0.3), // Button color
                                        child: SizedBox(width: 30, height: 30, child: Icon(Icons.person, color: CustomColor.themedarker,))
                                    ),
                                  ),
                                  SizedBox(width: 8,),
                                  Text('120+', style: CustomFont.blackMedBold,),
                                  Text(' Wakif Mendonasikan',style: CustomFont.blackMedLight,)
                                ],
                              ),
                            ],
                          ),
                          ElevatedButton.icon(
                            ...
                            label: Text('Laporan', style: CustomFont.whiteSmallBold),
                            onPressed: () {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width : 10),
                      Text('Al-Hikmah\nTuban', style: CustomFont.blackMedLight)
                    ],
                  )
                ],
              ),
                      ...
                      Wrap(
                        ...
                        children: [
                          if(isDescExpanded == false)...[
                            Text('${textSample}', style: CustomFont.basicTextgrey, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, maxLines: 5,),
                            GestureDetector(
                              onTap: () {
                                setState(() {
                              ...
                              child: new Text('Read More', style: CustomFont.orangeMedBold)
                            )
                          ] else ... [
                            Text('${textSample}', style: CustomFont.basicTextgrey, textAlign: TextAlign.left, ),
                            GestureDetector(
                                onTap: () {
                                  setState(() {
                                    isDescExpanded = !isDescExpanded;
                                ...
                                child: new Text('Read Less', style: CustomFont.orangeMedBold)
                            )
                          ]
              ...
              children: [
                Expanded(
                    child: ElevatedButton(
                        ...
                        onPressed: () {
                          Route route = MaterialPageRoute(builder: (context) => IndexForm());
